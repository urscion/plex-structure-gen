...
@dataclass
class LibraryItem(metaclass=ABCMeta):
...
@dataclass
class MediaFile(LibraryItem, metaclass=ABCMeta):
    @classmethod
    @abstractmethod
...
class VideoFile(MediaFile, metaclass=ABCMeta):
    def __init__(self):
        super().__init__()
...
class MediaImageAsset(metaclass=ABCMeta):
    """Image asset"""
